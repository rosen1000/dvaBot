...
export function getWelcome(member: GuildMember): string {
    let welcomes = [
        ...
        `Welcome, ${member}. Stay awhile amd listen.`,
        ...
        `${member} just jouned. Hide your bananas.`,
        ...
        `Challanger approaching - ${member} has appeared!`,
        ...
        `${member} is here, as the prophrcy foretold.`,
        `${member} has arrived. Party's over.`,
        `Ready player ${member}`,
        `${member} is here to kick butt and chew bubblegum. And ${member} is all out of gum.`,
        `Hello. Is it ${member} you are looking for?`,
        `${member} has joined. Stay while and listen!`,
